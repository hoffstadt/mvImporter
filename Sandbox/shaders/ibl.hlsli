...
//{
//    return texture(EnvironmentSampler, u_EnvRotation * n).rgb;
//}


//float4 getSpecularSample(float3 reflection, float lod)
//{
//    return tex2Dlod(EnvironmentSampler, u_EnvRotation * reflection, lod);
//}


//float4 getSheenSample(float3 reflection, float lod)
//{
//    return tex2Dlod(EnvironmentSampler, u_EnvRotation * reflection, lod);
//}
...
//    float2 f_ab = texture(u_GGXLUT, brdfSamplePoint).rg;
