...
float4 main(VSOut input) : SV_Target
{
    ...
    {
        albedo = AlbedoTexture.Sample(Sampler, input.UV).rgba * material.albedo;
    ...
    {
        float albedo_alpha = AlbedoTexture.Sample(Sampler, input.UV).a * material.albedo.a;
    ...
    float3 color = ambient + direct_spec + point_spec + emissive;
