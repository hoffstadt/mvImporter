...
static const char* sponzaPath = "C:/dev/MarvelAssets/Sponza/";
static const char* gltfPath = "C://dev//glTF-Sample-Models//2.0//";
static b8 loadGLTF = true;
static b8 loadSponza = false;
static f32 shadowWidth = 100.0f;
