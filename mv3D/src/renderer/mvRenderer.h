...
void mvRenderer_RenderMesh       (mvAssetManager& am, mvMesh& mesh, mvMat4 cam, mvMat4 proj);
void mvRenderer_RenderMesh       (mvAssetManager& am, mvMesh& mesh, mvMat4 cam, mvMat4 proj);
void mvRenderer_RenderMeshShadows(mvAssetManager& am, mvMesh& mesh, mvMat4 cam, mvMat4 proj);
